CREATE DATABASE  IF NOT EXISTS `bd_vacunas` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_vacunas`;
...
select*from Dosis;
select*from Persona ;
select*from Persona p where p.fechaNacimiento='2000-1-1';
select*from Dosis d inner join Persona p where p.tieneComorbilidad=0 and d.hora>'11:15:00' and d.hora<'11:45:00';
select*from Dosis d inner join Vacuna v on d.idDosis = v.idVacuna;