...
CREATE TABLE `personafisica` (
  ...
  CONSTRAINT `fk_personafisica_1` FOREIGN KEY (`idPersonaFisica`) REFERENCES `cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `personajuridica` (
  ...
  CONSTRAINT `fk_personajuridica_1` FOREIGN KEY (`idPersonaJuridica`) REFERENCES `cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inscripcionafip`(
  ...
  `inscripcionAfip` varchar(25) NOT NULL,
  `idCliente` int NOT NULL,
  PRIMARY KEY (`idInscripcionAfip`),
  KEY `fkCliente_idx` (`idCliente`),
  CONSTRAINT `fkCliente` FOREIGN KEY (`idInscripcionAfip`) REFERENCES `cliente` (`idCliente`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

LOCK TABLES `inscripcionafip` WRITE;
/*!40000 ALTER TABLE `inscripcionafip` DISABLE KEYS */;
INSERT INTO `inscripcionafip` VALUES (1,'Monotributo',1);
INSERT INTO `inscripcionafip` VALUES (2,'IVA',1);
/*!40000 ALTER TABLE `inscripcionafip` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
--
...
select*from inscripcionafip;
select*from personaJuridica;
select*from personaFisica;
-- Dump completed on 2017-05-29 20:34:36
